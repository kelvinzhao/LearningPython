...
# Twisted has a slightly defferent approach
def schedule_install(customer):
    ...
    #
    # For each customer, we schedule these processes on the CRM and that is
    # all our chief-Twisted developer has to do
